...
def _drift_findings(batch, reference, numeric_cols, ks_sig=0.15):
...
def diagnose(batch, reference, numeric_cols, missing_cols, threshold=0.5,
             z_thresh=5.0, frac_sig=0.005, ks_sig=0.15, rate_sig=0.02):
    """
